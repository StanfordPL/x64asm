...
*/
class NoRexR8 : public virtual R8 {
	public:
		inline NoRexR8(uint64_t val) : R8{val} { }
};

/** One of the byte general-purpose registers: AH, CH, DH, BH, AL, CL, DL, BL,
   	available when using a REX prefix. 
*/
class RexR8 : public virtual R8 {
	public:
		inline RexR8(uint64_t val) : R8{val} { }
};

/** One of the byte general-purpose registers: AL, CL, DL, BL. */
class Rl : public NoRexR8, public RexR8 {
	public:
		inline Rl(uint64_t val) : R8{val}, NoRexR8{val}, RexR8{val} { }
};

/** One of the byte general-purpose registers: AH, CH, DH, BH. */
class Rh : public NoRexR8 {
	public:
		inline Rh(uint64_t val) : R8{val}, NoRexR8{val} { }
};
...
*/
class Rb : public RexR8 {
	public:
		inline Rb(uint64_t val) : R8{val}, RexR8{val} { }
};
...
class Al : public Rl {
	public:
		inline Al() : R8{0}, Rl{0} { }
		inline Al(uint64_t ignore) : R8{0}, Rl{0} { }
};
...
class Cl : public Rl {
	public:
		inline Cl() : R8{1}, Rl{1} { }
		inline Cl(uint64_t ignore) : R8{1}, Rl{1} { }
};
