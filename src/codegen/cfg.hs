...
reg_mask2 name fxn1 fxn2 = instr_array "RegSet" ("Opcode::" ++ name) render
    where render i = "RegSet()" ++ 
          ...
          render_gp "DX"  = ".set(dx)"
          render_gp "SP"  = ".set(sp)"
          render_gp "EAX" = ".set(eax)"
          render_gp "ECX" = ".set(ecx)"
          render_gp "EDX" = ".set(edx)"
          render_gp "ESP" = ".set(esp)"
          render_gp "RAX" = ".set(rax)"
          render_gp "RBX" = ".set(rbx)"
          render_gp "RCX" = ".set(rcx)"
          render_gp "RDX" = ".set(rdx)"
          render_gp "RSP" = ".set(rsp)"					
          render_gp "RBP" = ".set(rbp)"
          render_gp "RSI" = ".set(rsi)"
          render_gp "RDI" = ".set(rdi)"
          render_gp "ST0" = "" -- TODO
          render_gp "TOP" = "" -- TODO
