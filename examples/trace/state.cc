...
ostream& operator<<(ostream& os, const State& s) {
	write_gp(os, "rax", s.general_purpose[rax]); os << endl;
	write_gp(os, "rbx", s.general_purpose[rbx]); os << endl;
	write_gp(os, "rcx", s.general_purpose[rcx]); os << endl;
	write_gp(os, "rdx", s.general_purpose[rdx]); os << endl;
	write_gp(os, "rdi", s.general_purpose[rdi]); os << endl;
	write_gp(os, "rsi", s.general_purpose[rsi]); os << endl;
	write_gp(os, "rbp", s.general_purpose[rbp]); os << endl;
	write_gp(os, "rsp", s.general_purpose[rsp]); os << endl;
	write_gp(os, "r8",  s.general_purpose[r8]);  os << endl;
	write_gp(os, "r9",  s.general_purpose[r9]);  os << endl;
	write_gp(os, "r10", s.general_purpose[r10]); os << endl;
	write_gp(os, "r11", s.general_purpose[r11]); os << endl;
	write_gp(os, "r12", s.general_purpose[r12]); os << endl;
	write_gp(os, "r13", s.general_purpose[r13]); os << endl;
	write_gp(os, "r14", s.general_purpose[r14]); os << endl;
	write_gp(os, "r15", s.general_purpose[r15]); os << endl;

	write_xmm(os, "xmm0",  s.xmm[xmm0]);  os << endl;
	write_xmm(os, "xmm1",  s.xmm[xmm1]);  os << endl;
	write_xmm(os, "xmm2",  s.xmm[xmm2]);  os << endl;
	write_xmm(os, "xmm3",  s.xmm[xmm3]);  os << endl;
	write_xmm(os, "xmm4",  s.xmm[xmm4]);  os << endl;
	write_xmm(os, "xmm5",  s.xmm[xmm5]);  os << endl;
	write_xmm(os, "xmm6",  s.xmm[xmm6]);  os << endl;
	write_xmm(os, "xmm7",  s.xmm[xmm7]);  os << endl;
	write_xmm(os, "xmm8",  s.xmm[xmm8]);  os << endl;
	write_xmm(os, "xmm9",  s.xmm[xmm9]);  os << endl;
	write_xmm(os, "xmm10", s.xmm[xmm10]); os << endl;
	write_xmm(os, "xmm11", s.xmm[xmm11]); os << endl;
	write_xmm(os, "xmm12", s.xmm[xmm12]); os << endl;
	write_xmm(os, "xmm13", s.xmm[xmm13]); os << endl;
	write_xmm(os, "xmm14", s.xmm[xmm14]); os << endl;
